...
TUTORIALS = {
    ...
    "happ": {
        ...
        "steps": [
            {
                "step": 1,
                "title": "اتصال مستقیم یا کپی لینک اشتراک",
                "desc": "روی دکمه «اتصال به Happ» در پنل یا وب‌اپلیکیشن کلیک کنید تا اشتراک مستقیماً وارد برنامه شود، یا لینک اشتراک خود را کپی نمایید.",
                "tip": "دکمه مستقیم برنامه Happ را خودکار باز کرده و سابسکریپشن را بدون هیچ خطایی ایمپورت می‌کند."
            },
            {
                "step": 2,
                "title": "ایمپورت دستی در اپلیکیشن (اختیاری)",
                "desc": "در صورت تمایل، برنامه Happ را اجرا کرده و دکمه (+) بالای صفحه را بزنید. گزینه Add Subscription را انتخاب کرده و لینک را قرار دهید.",
                "tip": "برنامه خودکار لیست سرورها و کانفیگ‌های فعال را دانلود و سازمان‌دهی می‌کند."
            },
            {
                "step": 3,
                "title": "اتصال سریع",
        ...
        "troubleshoot": [
            "اگر با خطای The subscription URL is not valid مواجه شدید، از دکمه اتصال مستقیم «اتصال به Happ» در پرتال کاربری استفاده کنید یا اطمینان حاصل فرمایید انتهای لینک عبارت /all.txt درج شده باشد.",
